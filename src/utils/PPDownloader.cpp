...
void PPDownloader_WebRequest() 
{
	...
	RET_V_UNLESS(il2cpp_utils::RunMethod(PP_WebRequestAPI, "SetRequestHeader", il2cpp_utils::createcsstr("User-Agent"), il2cpp_utils::createcsstr("Menu Utils / FutureMapper / " + modInfo.version)));
